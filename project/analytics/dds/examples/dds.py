...
CalcPar.argtypes = [ddTableDeal, c_int, POINTER(
    ddTableResults), POINTER(parResults)]
...
int vulnerable
pointer to struct parResults * presp"""
CalcParPBN.argtypes = [ddTableDealPBN, POINTER(
    ddTableResults), c_int, POINTER(parResults)]
...
int dealer
int vulnerable"""
DealerPar.argtypes = [POINTER(ddTableResults), POINTER(
    parResultsDealer), c_int, c_int]
...
int dealer
int vulnerable"""
DealerParBin.argtypes = [POINTER(ddTableResults), POINTER(
    parResultsMaster), c_int, c_int]
...
ConvertToSidesTextFormat.argtypes = [
    POINTER(parResultsMaster), POINTER(parTextResults)]
...
int chunkSize"""
AnalyseAllPlaysBin.argtypes = [POINTER(boards), POINTER(
    playTracesBin), POINTER(solvedPlays), c_int]
...
pointer to struct solvedPlays * solvedp
int chunkSize"""
AnalyseAllPlaysPBN.argtypes = [POINTER(boardsPBN), POINTER(
    playTracesPBN), POINTER(solvedPlays), c_int]
